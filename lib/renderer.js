...
exports.renderSerializable = function(input, options, indentation) {
    ...
    if (type === '[object Array]') return exports.renderEmptyArray(options, indentation)
    if (type === '[object Object]' && Object.keys(input).length === 0) return exports.renderEmptyObject(options, indentation)
...
exports.renderEmptyArray = function(options, indentation) {
    const output = utils.colorString(options.emptyArrayMsg, 'grey')
    return `${indentation}${output}\n`
}

exports.renderEmptyObject = function(options, indentation) {
    const output = utils.colorString(options.emptyObjectMsg, 'grey')
    return `${indentation}${output}\n`
}
